...
namespace GlennLuna.Api.Data.Migrations
{
    ...
    [Migration("20260717032848_AddObjectStorageKeys")]
    partial class AddObjectStorageKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GlennLuna.Api.Models.ContentTask", b =>
                {
                    ...
                    b.Property<string>("SubmissionFileObjectKey")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)");
            ...
            modelBuilder.Entity("GlennLuna.Api.Models.KidDesignSubmission", b =>
                {
                    ...
                    b.Property<string>("DesignFileObjectKey")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)");
            ...
            modelBuilder.Entity("GlennLuna.Api.Models.QuoteRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GlennLuna.Api.Models.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GlennLuna.Api.Models.UserNotification", b =>
                {
                    b.HasOne("GlennLuna.Api.Models.ApplicationUser", "User")
                        .WithMany()
